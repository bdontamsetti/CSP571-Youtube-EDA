...
plot_ly(data = df, x = ~data_total$likes, y = ~data_total$comment_count, z = ~data_total$views, color = ~cluster, colors = "Reds", type = "scatter3d", mode = "markers", marker = list(size = 5, opacity = 0.8)) %>%
